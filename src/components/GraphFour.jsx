      ...
      try {
        ...
        if (response.status === 200 && response.data.show.length) {
          ...
          setChartData({
            ...
            datasets: [
              {
                label: "Average Lost Percentage",
                data: processedData.data,
                fill: false,
                borderColor: "rgb(255, 159, 64)", // Bright color for visibility
          ...
          setChartOptions({
            ...
            plugins: {
              ...
              title: {
                display: true,
                text: "Average Lost Percentage Over Time",
...
function processChartData(data) {
  ...
  data.forEach((item) => {
    ...
    groupedByDate[dateStr].push(item.lost_percentage);
  });
